...
public class LayoutService
{
    ...
    {
        UserPreferences = await _userPreferenceService.LoadUserPreferences();
        ...
        CurrentTheme.Typography.Default.FontSize = UserPreferences.DefaultFontSize.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";
        CurrentTheme.Typography.Button.FontSize = UserPreferences.ButtonFontSize.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";
        CurrentTheme.Typography.Button.LineHeight = UserPreferences.ButtonLineHeight;
        CurrentTheme.Typography.Body1.FontSize = UserPreferences.Body1FontSize.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";
        ...
        CurrentTheme.Typography.Body2.FontSize = UserPreferences.Body2FontSize.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";
        CurrentTheme.Typography.Body2.LineHeight = UserPreferences.Body2LineHeight;
        CurrentTheme.Typography.Body2.LetterSpacing = UserPreferences.Body2LetterSpacing.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";

        CurrentTheme.Typography.Caption.FontSize = UserPreferences.CaptionFontSize.ToString("0.0000", CultureInfo.InvariantCulture) + "rem";
    ...
    public async Task ToggleDarkMode()
    {
        ...
        await _userPreferenceService.SaveUserPreferences(UserPreferences);
        OnMajorUpdateOccured();
    }
